...
![Model de l'àtom](../assets/images/electricitatElectronica/atom.png)
...
- Els **generadors** són els components que generen la circulació dels **electrons** i per tant de l'**electricitat**, podriem dir que "**empènyen**" els **electrons** per que avancin a través del circuit. Podem identificar diversos components com a generadors com ara: piles, bateries, alternadors o dinamos. A continuació hi ha imatges amb els seus símbols:
    - Pila ![Pila](../assets/images/electricitatElectronica/pila.jpg)
    - Bateria ![Bateria](../assets/images/electricitatElectronica/bateria.jpg)
    - Dinamo ![Dinamo](../assets/images/electricitatElectronica/dinamo.jpg)
    - Alternador ![Alternador](../assets/images/electricitatElectronica/alternador.jpg)
    - Símbol de generador ![Símbol de generador](../assets/images/electricitatElectronica/pilaSimbol.png)
...
![Conductor](../assets/images/electricitatElectronica/conductor.jpg)
...
- Els **receptors** són els components que reben l'**electricitat** i l'utilitzen per alguna funció transformant l'**energia elèctrica** en alguna altra forma d'**energia**. Per exemple: les **bombetes** incandescents la transformen en **energia lumínica i calorífica**, els **motors** en **energia mecànica**, les **estufes** en **energia calorífica**, els **timbres** en **energia sonora**... Aquests **receptors** cal que rebin la quantitat d'**electricitat** adequada per tal de funcionar correctament i, per tant, a vegades cal regular la quantitat d'**electricitat** que reben. Això es fa a través de **resistències** que són components **receptors** que només serveixen per tal de regular la **quantitat d'electricitat** que flueix pel circuit. A contínuació hi ha els símbols o imatges dels receptors més rellevants:
  - Resistència ![Imatge resistència](../assets/images/electricitatElectronica/resistencia.jpg)
![Símbol resistència](../assets/images/electricitatElectronica/resistenciaSimbol.jpg)
  - Bombeta ![Símbol bombeta](../assets/images/electricitatElectronica/bombetaSimbol.jpg)
  - Motor ![Símbol motor](../assets/images/electricitatElectronica/motorSimbol.png)
...
![Imatge interruptor](../assets/images/electricitatElectronica/interruptor.jpg)
![Símbol interruptor](../assets/images/electricitatElectronica/interruptorSimbol.jpg)
...
![Imatge i símbol interruptor](../assets/images/electricitatElectronica/commutadorSimbol.png)
...
![Imatge polsador](../assets/images/electricitatElectronica/polsador.jpg)
![Símbol polsador](../assets/images/electricitatElectronica/polsadorSimbol.png) 
...
![Imatge fusible](../assets/images/electricitatElectronica/fusible.jpg)
![Símbol fusible](../assets/images/electricitatElectronica/fusibleSimbol.png)
...
![Triangle llei d'Ohm](../assets/images/electricitatElectronica/lleiOhm.png)  
...
![Circuit simple](../assets/images/electricitatElectronica/circuitSimple.png)
...
![Circuit série](../assets/images/electricitatElectronica/circuitSerie.png)  
...
![Circuit paral·lel](../assets/images/electricitatElectronica/circuitParalel.png)
...
| --- | --- | --- | --- |
| Série | $$V_t=V_1+V_2+...+V_i$$ El voltatge es reparteix | $$R_t=R_1+R_2+...+R_i$$ <br> La resistència es reparteix| $$I_t=I_1=I_2=...=I_i$$ La intensitat es manté|
